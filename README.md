...
עמידר היא מערכת המחברת בין **שליחים** (messengers) למצטרפים (members) למען תפילות יומיות ותמיכה בצדקה. השליחים מגייסים מצטרפים דרך לינקים ייחודיים או QR codes, והמצטרפים מקבלים תפילות יומיות במקומות קדושים.
...
├── hooks/               # Custom hooks
├── layouts/
│   └── DashboardLayout.tsx  # Layout לדשבורדים
├── lib/
...
- כלי שיווק: לינק אישי, QR code להדפסה
